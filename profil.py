'''Define fonctions to grade the algorithm performances in an optimisation way.

'''

import torch
import torch.nn as nn
import resnet_factorized as resnet_factorized
...
def main():
    ...
    num_zeros=pruning_amount(model)
    print(model)
    flops, params = profile(model, (1,3,32,32))
    flops, params = flops.item(), params.item()-num_zeros/2
